...
const clients = new Skills(ICON_1, TITLE_TEXT_1, SUBTITLE_TEXT_1);
clients.buildSkills(outWhatCan);

const branding = new Skills(ICON_2, TITLE_TEXT_2, SUBTITLE_TEXT_2);
branding.buildSkills(outWhatCan);

const marketing = new Skills(ICON_3, TITLE_TEXT_3, SUBTITLE_TEXT_3);
marketing.buildSkills(outWhatCan);

const adv = new Skills(ICON_4, TITLE_TEXT_4, SUBTITLE_TEXT_4);
